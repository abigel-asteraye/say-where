...
const CategoryPage: React.FC<CategoryPageProps> = ({ title, description, spots }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-50">
      ...
      {spots.map((spot, index) => (
          <div className="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-all duration-300">
            ...
            <div className="w-full h-48 bg-cover bg-center" style={{ backgroundImage: `url(${spot.image})` }}></div>
