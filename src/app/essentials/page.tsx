...
const EssentialsPage = () => {
  ...
  const validSpots = spots.filter(
    (spot) => spot.location.latitude !== undefined && spot.location.longitude !== undefined && spot.tags.includes("essentials")
  );

  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gradient-to-b from-[#fdf1e4] to-[#f5deb3]">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-6">Essentials</h1>
      <p className="text-lg text-gray-700 mb-8">
        Here are the essentials near you!
      </p>
