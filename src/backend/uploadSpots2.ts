...
const spots = [
    ...
    },
    {
      ...
      description:
        "Local brewery offering craft beers and a menu of pub fare.",
      location: {
        latitude: 42.2030,
        longitude: -72.5795,
      },
    ...
    },
    {
      ...
      description: "A weekend celebration featuring live music, art exhibits, and family-friendly activities across South Hadley.",
      location: {
        latitude: 42.2068,
        longitude: -72.5742
      },
    ...
    {
      name: "Big Y",
      description: "Local grocery store offering fresh produce, bakery items, and a full-service deli.",
      location: {
        latitude: 42.2105,
        longitude: -72.5923
      },
    ...
    },
    {
      ...
      description: "Expansive park featuring hiking trails, scenic views, and diverse wildlife.",
      location: {
        latitude: 42.2886,
        longitude: -72.5390
      },
    ...
    },
    {
      ...
      description: "Modern library with comfortable reading rooms and views of the Connecticut River.",
      location: {
        latitude: 42.2061,
        longitude: -72.5747
      },
